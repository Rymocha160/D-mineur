...
new EcouteurSouris(this, partie);
...
nouvelle.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_N,
...
expert.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_E,
InputEvent.CTRL_MASK));
expert.setToolTipText("480 cases 99 mines");
perso = new JRadioButtonMenuItem("Personnalisé...");
perso.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_P,
InputEvent.CTRL_MASK));
...
design.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_G,
InputEvent.CTRL_MASK));
...
aide.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_A,
InputEvent.CTRL_MASK));
aide.setToolTipText("Pour obtenir de l’aide");
aPropos.add(aide);
aPropos.addSeparator();
createur = new JMenuItem("Créateurs");
createur.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_C,
InputEvent.CTRL_MASK));
...
int nb = partie.getMatrice().getMines()- partie.getMatrice().nbrDrapeau();
